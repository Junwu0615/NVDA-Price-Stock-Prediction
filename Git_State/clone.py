...
with open('NVDA-Price-Stock-Prediction_clone.json', 'r') as fh:
    now = json.load(fh)
with open('NVDA-Price-Stock-Prediction_clone_before.json', 'r') as fh:
    before = json.load(fh)
...
with open('NVDA-Price-Stock-Prediction_clone.json', 'w', encoding='utf-8') as fh:
